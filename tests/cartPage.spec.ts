...
test.describe('Cart page feature', () => {
  ...
  test(
    'TR008: Delete product from the cart via delete icon and check that empty cart is visible',
    {
      tag: '@positive',
    },
    async ({ cartPage }) => {
  ...
  test(
    'TR009: Delete product from the cart via delete [-] icon and check that for the empty cart [Proceed to checkout] button is disabled',
    {
      tag: '@positive',
    },
    async ({ cartPage }) => {
  ...
  test(
    'TR010: Navigate to the checkout page and check that URL is correct',
    {
      tag: '@positive',
    },
    async ({ cartPage, page }) => {
